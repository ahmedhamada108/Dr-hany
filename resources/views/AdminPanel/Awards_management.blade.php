...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ادارة الجوائز</li>
        </ol>
    </nav>
...
<div class="card">
  <div class="card-body">
    <h6 class="card-title">ادارة الجوائز</h6>
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">اضافة جائزة</button>
    ...
    <div class="table-responsive">
      <div id="dataTableExample_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
        ...
        <div class="row">
                ...
                <table style="margin-left: 10px;margin-right: 10px;" id="dataTableExample" class="table dataTable no-footer" role="grid" aria-describedby="dataTableExample_info">
                    ...
                    <tbody>
                        @foreach ($awards as $award )
                            <tr role="row{{ $award['id'] }}" class="odd">
                                <td class="sorting_1">{{ $award['title'] }}</td>
                                <td>
                                    <img src="{{URL::asset('storage/'.$award['image_path']) }}" alt="" style="width: 80px; border-radius: 50%;">
                                </td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#exampleModaledit{{ $award['id'] }}" data-whatever="@mdo">تعديل</button>
            ...
            {{-- Start Modal adding new image --}}
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <h5 class="modal-title" id="exampleModalLabel">اضافة جائزة جديدة</h5>
                            ...
                            <form action="{{ route('awards.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <label for="recipient-name" class="col-form-label">اسم الجائزة:</label>
           ...
           @foreach ($awards as $award)
                {{-- Start Modal Editing the image --}}
                          <div class="modal fade" id="exampleModaledit{{ $award['id'] }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form action="{{ route('awards.update',$award['id']) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    @method('PUT')
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">اسم الصورة:</label>
                                    <input type="text" name="title" class="form-control" id="recipient-name" value="{{ $award['title'] }}">
                                    </div>
                                    <div class="form-group">
                                    <label for="message-text" class="col-form-label">الصورة:</label>
                                    <input type="file" class="form-control" id="recipient-name" name="image_path">
        ...
        {{ $awards->links('vendor.pagination.bootstrap-4') }}
    </div>
</div>
</div>
</div>
